		...
		<div class="row">
			<div class="col-md-4">
				<div class="footer-widget about-widget">
					...
					<p>Printify is an online design,copying and printing company that is passionate about great design and the difference it can make to our customers and the world. Colors launched back in 2006 with the aim to disrupt the trillion-dollar global print industry.</p>
				</div>
			</div>
			<div class="col-md-2">
			...
			<div class="col-md-3">
				<div class="footer-widget links-widget services">
					...
					<ul class="link-list">
						<li><a href="service-details.php">Business Card</a></li>
						<li><a href="service-details.php">Flyers</a></li>
						<li><a href="service-details.php">Postcards</a></li>
						<li><a href="service-details.php">Stickers</a></li>
						<li><a href="service-details.php">Posters</a></li>
					</ul>
				</div>
			</div>
			<div class="col-md-3">
