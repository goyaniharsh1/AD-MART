                    ...
                    <div class="main-login main-center">
                        <form class="form-horizontal" method="POST" action="changepass.php">
                                ...
                                <div class="form-group">
                                    <label for="text" class="cols-sm-2 control-label"><font face="georgia">Sequrity Question:</font></label>
                                    <div class="cols-sm-10">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-lock fa" aria-hidden="true"></i></span>
                                                  <?php
                                    require 'dbconnects.php';
                                    $qry="SELECT * FROM securityque_tbl where s_id=$sid ";
                                ...
                                <input type="hidden" name="email" value="<?php echo $fn;?>">
                                <div class="form-group">
                                    <label for="password" class="cols-sm-2 control-label"><font face="georgia">Sequrity Answer:</font></label>
                                    <div class="cols-sm-10">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
                                            <input type="text" class="form-control" placeholder="Enter your Sequrity Answer" name="ans" required=""/>
                                        </div>
                                    </div>
                                </div>
