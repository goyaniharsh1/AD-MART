...
<div class="breadcumb-wrapper">
    <div class="thm-container">
        ...
        <li><span>Print Quotation</span></li>
    </ul>
</div>
</div>
...
<section class="about-section sec-pad">
   ...
   <div style="width:100%; padding:10px; float:left; background:#1ca8dd; color:#fff; font-size:30px; text-align:center;">
    ...
    <div class="row"><center>
        <input type="submit" value="Print"class="btn btn-primary center-block print" onclick="myFunction()">
      </center>
    </div>
</section>
<br/>
<div class="footer-bottom">
    <div class="thm-container clearfix">x`
